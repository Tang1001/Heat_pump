function T_results = system_of_equations_Euler_6layers_5R(time_data, T_initial, m_p_dot_data, T_in_data, m_s_dot_data, m1, m2, m3, m4, m5, m6, cp, R12, R23, R34, R45, R56, m_c_dot, diff_T_c, T_s)
...
for k = 1:length(time_data) - 1
    ...
    dT6dt = (m_p_dot * cp * (T(5) - T(6)) + R56 * (T(5) - T(6))*(60*60) + m_s_dot * cp * (T_s - T(6))) / (m6 * cp);
