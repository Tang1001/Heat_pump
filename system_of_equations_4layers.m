function dTdt = system_of_equations_4layers(t, T, m_p_dot_data, T_in_data, m_s_dot_data, time_data_1min, time_data_1h, m1, m2, m3, m4, cp, R1, R2, m_c_dot, diff_T_c, T_s)
    T1 = T(1);
    T2 = T(2);
    T3 = T(3);
    T4 = T(4);
