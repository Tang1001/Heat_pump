...
%Read data
%1min
Temp_out_water_he_13 = readcell('../Data/week 13 outlet water T in heat exchanger.csv');
Temp_out_water_he_13=cell2table(Temp_out_water_he_13(2:end,:));
Temp_in_water_hp_13 = readcell('../Data/week 13 inlet water T in heat pump.csv');
Temp_in_water_hp_13=cell2table(Temp_in_water_hp_13(2:end,:));
Temp_out_water_hp_13 = readcell('../Data/week 13 outlet water T in heat pump.csv');
Temp_out_water_hp_13=cell2table(Temp_out_water_hp_13(2:end,:));
FlowRate_water_hp_13 = readcell('../Data/week 13 water flow rate in heat pump.csv');
