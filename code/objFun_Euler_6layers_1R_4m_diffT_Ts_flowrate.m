function err = objFun_Euler_6layers_1R_4m_diffT_Ts_flowrate(time_data, T_initial, m_p_dot_interp, T_in_data_interp, m_s_dot_interp, m1, m2, cp, R12, H, A, k, params, data)
    R23 = params(1);
...
%     T_results = system_of_equations_Euler_6layers_5R_singlePipe(time_data, T_initial, m_p_dot_data, T_in_data, m_s_dot_data, m1, m2, m3, m4, m5, m6, cp, R12, R23, R34, R45, R56, m_c_dot, diff_T_c, T_s);
 T_results = system_of_equations_Euler_Nlayers(time_data, T_initial, m_p_dot_interp, T_in_data_interp, m_s_dot_interp, 2,4, [m1;m2], [m3;m4; m5;m6], R23, m_c_dot, diff_T_c, T_s);
