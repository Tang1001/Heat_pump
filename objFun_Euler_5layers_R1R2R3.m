function err = objFun_Euler_5layers_R1R2R3(time_data, T_initial, m_p_dot_data, T_in_data, m_s_dot_data, m1, m2, m3, m4, m5, cp, m_c_dot, diff_T_c, T_s, params, data)
    R12 = params(1);
    R34 = params(2);
    R45 = params(3);
...
%     err = mean((T(:,1) - data(:,1)).^2);    %Mean Squared Error
    err = sqrt(mean((T_results(:,5) - data(:,3)).^2));    %Root Mean Squared Error
