...
%Read data
%1min
Temp_out_water_he_19 = readcell('../data/week 19 outlet water T in heat exchanger.csv');
...
Temp_out_water_hp_19 = readcell('../data/week 19 outlet water T in heat pump.csv');
...
FlowRate_water_hp_19 = readcell('../data/week 19 water flow rate in heat pump.csv');
