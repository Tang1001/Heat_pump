...
num_layer_tank1_index = [2:10];
num_layer_tank2_index = [2:20];

err_upper_tank1 = zeros(length(num_layer_tank1_index),length(num_layer_tank2_index));
err_upper_tank2 = zeros(length(num_layer_tank1_index),length(num_layer_tank2_index));
err_bottom_tank2 = zeros(length(num_layer_tank1_index),length(num_layer_tank2_index));

for i=1:length(num_layer_tank1_index)
num_layer_tank1=num_layer_tank1_index(i);
    for j=1:length(num_layer_tank2_index)
        num_layer_tank2=num_layer_tank2_index(j);
m_layer_tank1 = ones(num_layer_tank1,1)*500/num_layer_tank1;
m_layer_tank2 = ones(num_layer_tank2,1)*500/num_layer_tank2;
        ...
        err_upper_tank1(i,j) = sqrt(mean((T_results(:,1) - T_ground_truth(:,1)).^2));               %Root Mean Squared Error
        err_upper_tank2(i,j) = sqrt(mean((T_results(:,num_layer_tank1+1) - T_ground_truth(:,2)).^2));               %Root Mean Squared Error
        err_bottom_tank2(i,j) = sqrt(mean((T_results(:,num_layer_tank1+num_layer_tank2) - T_ground_truth(:,3)).^2));               %Root Mean Squared Error
...
figure;
subplot(3,1,1)
h=heatmap(num_layer_tank2_index,num_layer_tank1_index,err_upper_tank1)
h.Colormap = winter;
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
title('Error of the upper temperature in tank1')
subplot(3,1,2)
h=heatmap(num_layer_tank2_index,num_layer_tank1_index,err_upper_tank2)
h.Colormap = winter;
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
title('Error of the upper temperature in tank2')
subplot(3,1,3)
h=heatmap(num_layer_tank2_index,num_layer_tank1_index,err_bottom_tank2)
h.Colormap = winter;
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
...
figure;
h=heatmap(num_layer_tank2_index,num_layer_tank1_index,err_upper_tank1+err_upper_tank2+err_bottom_tank2)
h.Colormap = winter;
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
title('Total error')
...
figure;
subplot(3,1,1)
surf(num_layer_tank2_index, num_layer_tank1_index, err_upper_tank1);
colorbar;  % Adds a colorbar to the figure
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
zlabel('Error of the upper temperature in tank1')
subplot(3,1,2)
surf(num_layer_tank2_index, num_layer_tank1_index, err_upper_tank2);
colorbar;  % Adds a colorbar to the figure
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
zlabel('Error of the upper temperature in tank2')
subplot(3,1,3)
surf(num_layer_tank2_index, num_layer_tank1_index, err_bottom_tank2);
colorbar;  % Adds a colorbar to the figure
xlabel('The number of layers in tank2')
ylabel('The number of layers in tank1')
